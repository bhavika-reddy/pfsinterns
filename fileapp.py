...
image_icon=PhotoImage(file="file-transfer.png")
root.iconphoto(False,image_icon)

Label(root,text="File Transfer",font=("Times New Roman",20,'bold'),bg="#f4fdfe").place(x=20,y=30)
...
#label
Label(root,text="Send",font=('Times New Roman',17,'bold'),bg="#f4fdfe").place(x=65,y=200)
Label(root,text="Receive",font=('Times New Roman',17,'bold'),bg="#f4fdfe").place(x=300,y=200)
